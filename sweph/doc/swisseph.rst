...
`0.1. Editing history 1 <#editing-history>`__

`0.2. Swiss Ephemeris release history
2 <#swiss-ephemeris-release-history>`__

`1. Introduction 4 <#introduction>`__

`1.1. Licensing 4 <#licensing>`__

`2. Description of the ephemerides
4 <#description-of-the-ephemerides>`__

`2.1. Planetary and lunar ephemerides
4 <#planetary-and-lunar-ephemerides>`__

`2.1.1. Three ephemerides 4 <#three-ephemerides>`__

`2.1.2. The Swiss Ephemeris Compared with Astronomical Almanac and JPL
Horizons
9 <#the-swiss-ephemeris-compared-with-astronomical-almanac-and-jpl-horizons>`__

`2.1.3. The details of coordinate transformation
13 <#the-details-of-coordinate-transformation>`__

`2.1.4. The Swiss Ephemeris compression mechanism
14 <#the-swiss-ephemeris-compression-mechanism>`__

`2.1.5. The extension of DE406-based ephemerides to 10.800 years
15 <#the-extension-of-de406-based-ephemerides-to-10.800-years>`__

`2.1.6. Solar Ephemeris in the remote past
16 <#solar-ephemeris-in-the-remote-past>`__

`2.2. Lunar and Planetary Nodes and Apsides
16 <#lunar-and-planetary-nodes-and-apsides>`__

`2.2.1. Mean Lunar Node and Mean Lunar Apogee (Lilith, Black Moon in
astrology)
16 <#mean-lunar-node-and-mean-lunar-apogee-lilith-black-moon-in-astrology>`__

`2.2.2. The True Node 17 <#the-true-node>`__

`2.2.3. The Osculating Apogee (astrological True Lilith or True Dark
Moon)
18 <#the-osculating-apogee-astrological-true-lilith-or-true-dark-moon>`__

`2.2.4. The Interpolated or Natural Apogee and Perigee (astrological
Lilith and Priapus)
19 <#the-interpolated-or-natural-apogee-and-perigee-astrological-lilith-and-priapus>`__

`2.2.5. Planetary Nodes and Apsides 19 <#planetary-nodes-and-apsides>`__

`2.3. Asteroids 22 <#asteroids>`__

`2.3.1. Asteroid ephemeris files 22 <#asteroid-ephemeris-files>`__

`2.3.2. How the asteroids were computed
22 <#how-the-asteroids-were-computed>`__

`2.3.3. Ceres, Pallas, Juno, Vesta 23 <#ceres-pallas-juno-vesta>`__

`2.3.4. Chiron 23 <#chiron>`__

`2.3.5. Pholus 23 <#pholus>`__

`2.3.6. Asteroid 99942 Apophis 23 <#asteroid-99942-apophis>`__

`2.3.7. Ceres - an application program for asteroid astrology
24 <#ceres---an-application-program-for-asteroid-astrology>`__

`2.4. Planetary Centers of Body (COB) and Planetary Moons
24 <#planetary-centers-of-body-cob-and-planetary-moons>`__

`2.5. Comets and Interstellar Objects
24 <#comets-and-interstellar-objects>`__

`2.6. Fixed stars and Galactic Center
25 <#fixed-stars-and-galactic-center>`__

`2.7. Hypothetical bodies 25 <#hypothetical-bodies>`__

`2.7.1. Uranian planets (Hamburg planets: Cupido, Hades, Zeus, Kronos,
Apollon, Admetos, Vulkanus, Poseidon)
25 <#uranian-planets-hamburg-planets-cupido-hades-zeus-kronos-apollon-admetos-vulkanus-poseidon>`__

`2.7.2. Transpluto (Isis) 25 <#transpluto-isis>`__

`2.7.3. Harrington 26 <#harrington>`__

`2.7.4. Nibiru 26 <#nibiru>`__

`2.7.5. Vulcan 26 <#vulcan>`__

`2.7.6. Selena/White Moon 26 <#selenawhite-moon>`__

`2.7.7. Dr. Waldemath’s Black Moon 26 <#dr.-waldemaths-black-moon>`__

`2.7.8. The Planets X of Leverrier, Adams, Lowell and Pickering
27 <#the-planets-x-of-leverrier-adams-lowell-and-pickering>`__

`2.8. Sidereal Ephemerides for Astrology
27 <#sidereal-ephemerides-for-astrology>`__

`2.8.1. The problem of defining the zodiac
27 <#the-problem-of-defining-the-zodiac>`__

`2.8.2. The Babylonian tradition and the Fagan/Bradley ayanamsha
28 <#the-babylonian-tradition-and-the-faganbradley-ayanamsha>`__

`2.8.3. The Hipparchan tradition 29 <#the-hipparchan-tradition>`__

`2.8.4. Suryasiddhanta and Aryabhata
30 <#suryasiddhanta-and-aryabhata>`__

`2.8.5. The Spica/Citra tradition and the Lahiri ayanamsha
31 <#the-spicacitra-tradition-and-the-lahiri-ayanamsha>`__

`2.8.6. Krishnamurti ayanamshas 34 <#krishnamurti-ayanamshas>`__

`2.8.7. The sidereal zodiac and the Galactic Center
35 <#the-sidereal-zodiac-and-the-galactic-center>`__

`2.8.8. The sidereal zodiac and the Galactic Equator
36 <#the-sidereal-zodiac-and-the-galactic-equator>`__

`2.8.9. Other ayanamshas 37 <#other-ayanamshas>`__

`2.8.10. Conclusions 39 <#conclusions>`__

`2.8.11. Ayanamshas with different precession rates
40 <#ayanamshas-with-different-precession-rates>`__

`2.8.12. On which ecliptic is the ayanamsha measured?
42 <#on-which-ecliptic-is-the-ayanamsha-measured>`__

`2.8.13. More benefits from our new sidereal algorithms: standard
equinoxes and precession-corrected transits
48 <#more-benefits-from-our-new-sidereal-algorithms-standard-equinoxes-and-precession-corrected-transits>`__

`3. Apparent versus true planetary positions
48 <#apparent-versus-true-planetary-positions>`__

`4. Geocentric, topocentric, heliocentric, barycentric, and
planetocentric positions
49 <#geocentric-topocentric-heliocentric-barycentric-and-planetocentric-positions>`__

`5. Heliacal Events, Eclipses, Occultations, and Other Planetary
Phenomena
49 <#heliacal-events-eclipses-occultations-and-other-planetary-phenomena>`__

`5.1. Heliacal Events of the Moon, Planets and Stars
49 <#heliacal-events-of-the-moon-planets-and-stars>`__

`5.1.1. Introduction 49 <#introduction-1>`__

`5.1.2. Aspect determining visibility
50 <#aspect-determining-visibility>`__

`5.1.3. Functions to determine the heliacal events
51 <#functions-to-determine-the-heliacal-events>`__

`5.1.4. Future developments 51 <#future-developments>`__

`5.1.5. References 52 <#references>`__

`5.2. Eclipses, occultations, risings, settings, and other planetary
phenomena
52 <#eclipses-occultations-risings-settings-and-other-planetary-phenomena>`__

`6. Sidereal Time, Ascendant, MC, Houses, Vertex
52 <#sidereal-time-ascendant-mc-houses-vertex>`__

`6.1. Sidereal Time 52 <#sidereal-time>`__

`6.2. Astrological House Systems 53 <#astrological-house-systems>`__

`6.2.1. Placidus 53 <#placidus>`__

`6.2.2. Koch/GOH 53 <#kochgoh>`__

`6.2.3. Regiomontanus 53 <#regiomontanus>`__

`6.2.4. Campanus 53 <#campanus>`__

`6.2.5. Equal Systems 53 <#equal-systems>`__

`6.2.6. Porphyry Houses and Related House Systems
54 <#porphyry-houses-and-related-house-systems>`__

`6.2.7. Axial rotation systems 55 <#axial-rotation-systems>`__

`6.2.8. The Morinus system 55 <#the-morinus-system>`__

`6.2.9. Horizontal system 55 <#horizontal-system>`__

`6.2.10. The Polich-Page (“topocentric”) system
55 <#the-polich-page-topocentric-system>`__

`6.2.11. Alcabitus system 55 <#alcabitus-system>`__

`6.2.12. Gauquelin sectors 56 <#gauquelin-sectors>`__

`6.2.13. Krusinski/Pisa/Goelzer system
56 <#krusinskipisagoelzer-system>`__

`6.2.14. APC house system 57 <#apc-house-system>`__

`6.2.15. Sunshine house system 57 <#sunshine-house-system>`__

`6.3. Vertex, Antivertex, East Point and Equatorial Ascendant etc.
57 <#vertex-antivertex-east-point-and-equatorial-ascendant-etc.>`__

`6.4. House cusps beyond the polar circle
58 <#house-cusps-beyond-the-polar-circle>`__

`6.4.1. Implementation in other calculation modules:
58 <#implementation-in-other-calculation-modules>`__

`6.5. House position of a planet 58 <#house-position-of-a-planet>`__

`6.6. Gauquelin sector position of a planet
59 <#gauquelin-sector-position-of-a-planet>`__

`6.7. Improvement of the Placidus house calculation in SE 2.09
60 <#improvement-of-the-placidus-house-calculation-in-se-2.09>`__

`7. ΔT (Delta T) 60 <#δt-delta-t>`__

`8. Programming Environment 64 <#programming-environment>`__

`9. Swiss Ephemeris Functions 64 <#swiss-ephemeris-functions>`__

`9.1. Swiss Ephemeris API 64 <#swiss-ephemeris-api>`__

`9.1.1. Calculation of planets and stars
65 <#calculation-of-planets-and-stars>`__

`9.1.2. Date and time conversion 65 <#date-and-time-conversion>`__

`9.1.3. Initialization, setup, and closing functions
65 <#initialization-setup-and-closing-functions>`__

`9.1.4. House calculation 65 <#house-calculation>`__

`9.1.5. Auxiliary functions 66 <#auxiliary-functions>`__

`9.1.6. Other functions that may be useful
66 <#other-functions-that-may-be-useful>`__

`9.2. Placalc API 67 <#placalc-api>`__

`Appendix 68 <#appendix>`__

`A. The gravity deflection for a planet passing behind the Sun
68 <#a.-the-gravity-deflection-for-a-planet-passing-behind-the-sun>`__

`B. A list of asteroids 69 <#b.-a-list-of-asteroids>`__

`C. How to Compare the Swiss Ephemeris with Ephemerides of the JPL
Horizons System
76 <#c.-how-to-compare-the-swiss-ephemeris-with-ephemerides-of-the-jpl-horizons-system>`__

`Test 1: Astrometric Positions ICRF/J2000
76 <#test-1-astrometric-positions-icrfj2000>`__

`Test 2: Inertial Apparent Positions, RA and DE, in ICRF
78 <#test-2-inertial-apparent-positions-ra-and-de-in-icrf>`__

`Test 3: Apparent Positions, True Equinox of Date, RA, DE, Ecliptic
Longitude and Latitude
79 <#test-3-apparent-positions-true-equinox-of-date-ra-de-ecliptic-longitude-and-latitude>`__

`Test 4: Heliocentric Apparent Positions, Ecliptic Longitude and
Latitude
80 <#test-4-heliocentric-apparent-positions-ecliptic-longitude-and-latitude>`__

`Test 5: Ephemerides before 1962 81 <#test-5-ephemerides-before-1962>`__

`Test 6: Jupiter versus Jupiter Barycentre
82 <#test-6-jupiter-versus-jupiter-barycentre>`__

`Test 7: Jupiter’s Center of Body
84 <#test-7-jupiters-center-of-body>`__

`Test 8: Geocentric Position of a Planetary Moon
84 <#test-8-geocentric-position-of-a-planetary-moon>`__

`Test 9: Planetocentric Position of a Planetary Moon
85 <#test-9-planetocentric-position-of-a-planetary-moon>`__

`Test 10: Topocentric Position of a Planet
86 <#test-10-topocentric-position-of-a-planet>`__

`D. How to compare the Swiss Ephemeris with Ephemerides of the
Astronomical Almanac (apparent positions)
88 <#d.-how-to-compare-the-swiss-ephemeris-with-ephemerides-of-the-astronomical-almanac-apparent-positions>`__

`Test 1: Astronomical Almanac online
88 <#test-1-astronomical-almanac-online>`__

`Test 2: Astronomical Almanac printed
88 <#test-2-astronomical-almanac-printed>`__

`E. How to compare the Swiss Ephemeris Lahiri Ayanamsha with Indian
Astronomical Ephemeris (IAE)
89 <#e.-how-to-compare-the-swiss-ephemeris-lahiri-ayanamsha-with-indian-astronomical-ephemeris-iae>`__

SWISS EPHEMERIS - computer ephemeris for developers of astrological
software
...
| 0 |         |                                                        |
+===+=========+========================================================+
| 1 | 9-o     | simplified houses() and sidtime() functions, Vertex    |
| . | ct-1997 | added.                                                 |
| 0 |         |                                                        |
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 16-o    | houses() changed again                                 |
| . | ct-1997 |                                                        |
| 0 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
...
| 4 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 9-j     | bug fix, pushed to all licensees                       |
| . | an-1998 |                                                        |
| 1 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
...
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 21-j    | NEW: topocentric planets and house positions           |
| . | an-1998 |                                                        |
| 2 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 28-j    | Delphi declarations and sample for Delphi 1.0          |
| . | an-1998 |                                                        |
| 2 |         |                                                        |
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 2-f     | asteroids moved to subdirectory. Swe_calc() finds them |
| . | eb-1998 | there.                                                 |
| 2 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 11-f    | two minor bug fixes.                                   |
| . | eb-1998 |                                                        |
| 2 |         |                                                        |
| 3 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 7-m     | documentation for Borland C++ Builder added            |
| . | ar-1998 |                                                        |
| 2 |         |                                                        |
| 4 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 4-ju    | sample for Borland Delphi-2 added                      |
| . | ne-1998 |                                                        |
| 2 |         |                                                        |
| 5 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 29-n    | source added, Placalc API added                        |
| . | ov-1998 |                                                        |
| 2 |         |                                                        |
| 6 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 17-d    | NEW: Time range extended to 10.800 years               |
| . | ec-1998 |                                                        |
| 3 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
...
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 19-a    | NEW: planetary phenomena                               |
| . | pr-1999 |                                                        |
| 4 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 27-j    | NEW: sidereal ephemerides                              |
| . | ul-1999 |                                                        |
| 5 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 15-f    | several NEW features, minor bug fixes                  |
| . | eb-2000 |                                                        |
| 5 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 15-f    | major release with many new features and some minor    |
| . | eb-2000 | bug fixes                                              |
| 6 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 11-s    | minor release, additions to se_rise_trans(),           |
| . | ep-2000 | swe_houses(), fictitious planets                       |
| 6 |         |                                                        |
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 23-j    | minor release, fictitious Earth satellites, asteroid   |
| . | ul-2001 | numbers > 55535 possible                               |
| 6 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 5-j     | minor release, house calculation added to swetest.c    |
| . | an-2002 | and swetest.exe                                        |
| 6 |         |                                                        |
| 3 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 7-a     | NEW: occultations of planets, minor bug fixes, new     |
| . | pr-2002 | Delta T algorithms                                     |
| 6 |         |                                                        |
| 4 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 12-j    | minor release, small code renovations for 64-bit       |
| . | un-2003 | compilation                                            |
| 6 |         |                                                        |
| 5 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 10-j    | NEW: Morinus houses                                    |
| . | ul-2003 |                                                        |
| 6 |         |                                                        |
| 6 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 31-m    | minor release: Delta-T updated, minor bug fixes        |
| . | ar-2005 |                                                        |
| 6 |         |                                                        |
| 7 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 2-m     | IAU resolutions up to 2005 implemented; "interpolated" |
| . | ar-2006 | lunar apsides                                          |
| 7 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 28-n    | Delta T calculation according to Morrison/Stephenson   |
| . | ov-2007 | 2004                                                   |
| 7 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 17-j    | license model changed to dual license, GNU GPL or      |
| . | un-2008 | Professional License                                   |
| 7 |         |                                                        |
| 4 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 31-m    | NEW: Heliacal events                                   |
| . | ar-2009 |                                                        |
| 7 |         |                                                        |
| 6 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 25-j    | Delta T calculation updated acc. to Espenak/Meeus      |
| . | an-2011 | 2006, new fixed stars file                             |
| 7 |         |                                                        |
| 7 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 2-a     | precession calculation updated acc. to Vondrák et alii |
| . | ug-2012 | 2012                                                   |
| 7 |         |                                                        |
| 8 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 23-a    | new ayanamshas, improved precision of eclipse          |
| . | pr-2013 | functions, minor bug fixes                             |
| 7 |         |                                                        |
| 9 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 1 | 3-s     | security update and bugfixes                           |
| . | ep-2013 |                                                        |
| 8 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 11-f    | Swiss Ephemeris now based on JPL ephemeris DE431       |
| . | eb-2014 |                                                        |
| 0 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 18-m    | bug fixes for version 2.00                             |
| . | ar-2015 |                                                        |
| 0 |         |                                                        |
| 1 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 11-a    | new functions swe_deltat_ex() and                      |
| . | ug-2015 | swe_get_ayanamsa_ex(); bug fixes.                      |
| 0 |         |                                                        |
| 2 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 16-o    | Swiss Ephemeris thread safe; minor bug fixes           |
| . | ct-2015 |                                                        |
| 0 |         |                                                        |
| 3 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 21-o    | V. 2.03 had DLL with calling convention \__cdecl; we   |
| . | ct-2015 | return to \_stdcall                                    |
| 0 |         |                                                        |
| 4 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 22-a    | new house methods, new ayanamshas, minor bug fixes     |
| . | pr-2015 |                                                        |
| 0 |         |                                                        |
| 5 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 10-j    | new Delta T, minor bug fixes                           |
| . | an-2017 |                                                        |
| 0 |         |                                                        |
| 6 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 10-j    | better performance of swe_fixstar() and                |
| . | an-2018 | swe_rise_trans()                                       |
| 0 |         |                                                        |
| 7 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 13-j    | update of Delta T and minor bug fixes                  |
| . | un-2019 |                                                        |
| 0 |         |                                                        |
| 8 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 22-j    | Improved Placidus houses, sidereal ephemerides,        |
| . | ul-2020 | planetary magnitudes; minor bug fixes                  |
| 0 |         |                                                        |
| 9 |         |                                                        |
+---+---------+--------------------------------------------------------+
| 2 | 10-d    | NEW: planetary moons                                   |
| . | ec-2020 |                                                        |
| 1 |         |                                                        |
| 0 |         |                                                        |
+---+---------+--------------------------------------------------------+
...
Differences (in arc sec) in precession (v. 1.78 – v. 1.77, test star was
Aldebaran)
...
Since the planet's light needs time to reach the Earth, it is never seen
where it actually is, but where it was some time before. Light-time
...
which is an adjustment of the ELP2000-85 lunar theory to the JPL
ephemeris on the interval from 3000 BCE to 3000 CE. Its deviation from
the mean node of ELP2000-85 is 0 for J2000 and remains below 20 arc
...
Revilla] The concept of 'mean lunar orbit' means that short term. e.g.
monthly, fluctuations must not be taken into account. In the temporal
average, the EMB coincides with the geocenter. Therefore, when mean
elements are computed, it is correct only to consider the geocenter, not
...
plane of the ecliptic. Or in other words, the nodes are the
...
Moon is in exact conjunction with them, it has indeed a zero latitude.
This is not so with the mean nodes.
...
using 'les 58 premiers termes correctifs au perigée moyen' published by
Chapront and Chapront-Touzé. And he adds: ”Nous constatons que même en
utilisant ces 58 termes correctifs, l'erreur peut atteindre 0,5d!” (p.
13) We avoid this error, computing the orbital elements from the
...
apogee. They are not included in the SWISSEPH package. All of them work
with a correction table.
...
This solution has been called the "*interpolated*" or "realistic" apogee
and perigee by Dieter Koch in his publications. Juan Revilla prefers to
call them the "*natural*" apogee and perigee. Today, Dieter Koch would
prefer the designation "natural". The designation "interpolated" is a
bit misleading, because it associates something that astrologers used to
do every day in old days, when they still used to work with printed
...
-  Juan Revilla, "The Astronomical Variants of the Lunar Apogee - Black
   Moon".
...
-  They can be understood as an axis defined by the intersection line of
   two orbital planes. E.g., the nodes of Mars are defined by the
...
| (http://thenewage.com/resources/articles/interface.html), planetary
  ...
  an intersection line for the two orbital planes of Mars and Saturn.
  Such non-ecliptic nodes have not been implemented in the Swiss
  Ephemeris.
...
Sun, resp. The former point is called the ”\ *perihelion*\ ” and the
latter one the ”\ *aphelion*\ ”. For a geocentric chart, these points
could be transformed from the heliocenter to the geocenter.
...
"apsides" of the solar orbit around the Earth, i.e. points on the orbit
of the Sun where it is closest to and where it is farthest from the
Earth. These points form an opposition and are used by some astrologers,
e.g. by the Dutch astrologer George Bode or the Swiss astrologer Liduina
Schmed. The ”perigee”, located at about 13 Capricorn, is called the
"Black Sun", the other one, in Cancer, is called the ”Diamond”.
...
nodes and apsides are "true" only at the precise moments, when the body
passes through them, but for the times in between, they are a mere
...
wild oscillation of the osculating or "true" perihelion (and aphelion),
which is not due to a transformation of the orbital ellipse but rather
due to the deviation of the heliocentric orbit from an elliptic shape.
Neptune’s orbit cannot be adequately represented by a heliocentric
ellipse.
...
-  Same as 1), but for Pluto and asteroids beyond Jupiter, a barycentric
   ellipse is used.
...
-  for all named asteroids also a long (6000 years) file is available in
   the download area.
...
-  Only some of the minor planets are known to better than an arc second
   for recent decades. (See also information below on Ceres, Chiron, and
   Pholus.)

-  Bowells elements do not consider relativistic effects, which leads to
   significant errors with long-term integrations of a few
...
to Chiron's. It was discovered in 1992. Pholus' orbital elements are not
yet as well-established as Chiron's. Our ephemeris is reliable from 1500
CE through now. Outside the 20th century it will probably have to be
corrected by several arc minutes during the coming years.
...
`swetest.htm <https://www.astro.com/swisseph/swetest.htm>`__. The output
will be:)

+---------+-----------+---------------+--------------+---------------+
|         |           | **difference  | **difference | **difference  |
|         |           | in            | in           | in            |
|         |           | longitude**   | latitude**   | solar         |
|         |           |               |              | distance**    |
+=========+===========+===============+==============+===============+
| Nep-Lev | 0         | -18°0'52.3811 | 0°55'0.0332  | -6.610753489  |
|         | 1.01.1770 |               |              |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | -8°42'9.1113  | 1°42'55.7192 | -4.257690148  |
|         | 1.01.1790 |               |              |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | -3°49'45.2014 | 1°35'12.0858 | -2.488363869  |
|         | 2.01.1810 |               |              |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | -1°38'2.8076  | 0°35'57.0580 | -2.112570665  |
|         | 2.01.1830 |               |              |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | 1°44'23.0943  | -            | -3.340858070  |
|         | 2.01.1850 |               | 0°43'38.5357 |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | 9°17'34.4981  | -            | -5.513270186  |
|         | 2.01.1870 |               | 1°39'24.1004 |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | 21°20'56.6250 | -            | -7.720578177  |
|         | 2.01.1890 |               | 1°38'43.1479 |               |
+---------+-----------+---------------+--------------+---------------+
| Nep-Lev | 0         | 36°27'56.1314 | -            | -9.265417529  |
|         | 3.01.1910 |               | 0°41'59.4866 |               |
+---------+-----------+---------------+--------------+---------------+
...
Sun), half-year" and *aṃśaḥ*, "part", thus literally means "part of the
course". It refers to the distance of a solstice from the initial point
of the cardinal zodiac sign that is associated with it. This distance
equals the distance of the vernal point from the sidereal Aries point.
(The correct pronunciation of *ayanāṃśaḥ* is with “sh”, although many
write and pronounce it with an “s”.)
...
sidereal_0_Aries = tropical_0_Aries + ayanamsha(t).
...
evidence – from a mere astronomical point of view – for anyone of them.
However, a historical study shows at least that many of them are related
to each other and the basic approaches are not so many.
...
opined in print prior to "New Tool" that it made more sense to consider
Aldebaran and Antares, at 15 degrees of their respective signs, as prime
fiducials than it did to use Spica at 29 Virgo”. Such statements raise
the question if the sidereal zodiac ought to be tied up to one of those
stars.
...
ayanamsha = -3.2° +- 0.09° [2]_; t0 = 1 Jan. 0 Spica at 29 vi 14’58”.
...
-  James H. Holden, “The Classical Zodiac”, in: AFA Journal of Research,
   vol. 7, no. 2 1995, p. 12.
...
June –128 (jd 1674484) and zePsc would be found at 29pi12’, which is too
far from the place where it ought to be.
...
1. We can find the place of the mean Sun at that time using modern
   astronomical algorithms and define this point as the beginning of the
   sidereal zodiac.
...
-  Surya-Siddhanta: A Text Book of Hindu Astronomy by Ebenezer Burgess,
      ed. Phanindralal Gangooly (1989/1997) with a 45-page commentary by
      P. C. Sengupta (1935).

-  D. Pingree, "Precession and Trepidation in Indian Astronomy", in JHA
      iii (1972), pp. 28f.
...
ayanamsha = 23°15' 00".658 21 March 1956, 0:00 TDT Lahiri, Spica (2000)
179°58'58”
...
The committee decreed that the ayanamsha had the value 23°15' 00" on the
21 March 1956, 0:00 Ephemeris Time. It became the basis of ayanamsha
...
17\ :sup:`h` 48\ :sup:`m` Ephemeris time or 15\ :sup:`h` 57\ :sup:`m`
U.T. of that year, has accordingly been adopted as the fixed initial
point of the Sidereal or Indian *Nirayaṇa* system of Astronomy.”
...
considered it insignificant and, "for the sake of uniformity", took over
the standard ayanamsha recommended by the CRC. The ayanamsha values and
sidereal positions of the Sun and the Moon which he gives in his
...
for “1900, Jan. 0 (= 31 Dec. 1899; D.K.), 19\ :sup:`h` 31\ :sup:`m` ET”.
Using a version of swetest which calculates uses Newcomb precession (the
...
-  Lahiri, N. C., *Panchanga Darpan* (in Bengali), Calcutta, 1967 (Astro
      Research Bureau).
...
the ecliptic must be corrected by 3'11", and the "Galactic Alignment"
preponed to 1994 (instead of 1998). With this ayanamsha, the galactic
node is fixed exactly at sidereal 0° Sagittarius.
...
that the Sanskrit word mūlam means "root, origin", and it seems that the
circle of the lunar mansions originally began with this nakshatra. On
the opposite side, the galactic equator cuts the ecliptic exactly at the
beginning of the nakshatra Ārdrā ("the moist, green, succulent one",
feminine).
...
July 1999): ”The "Djwhal Khul" ayanamsha originates from information in
an article in the Journal of Esoteric Psychology, Volume 12, No 2,
...
| “Also, I know the “real" source of the 2117 date for the DK (= Djwhal
  Khul) Ayanamsa and the original provenance of it. It was not Lindsay
  or Robbins or the journal of Esoteric Psychology. My friend Keith
  Bailey, inherited a whole bunch of papers from Marion Walter’s who was
  one of the members of the “DINA” group discussed in Alice Bailey’s
  books. DK answered a question from Roberto Assagioli and in the answer
  he mentioned that “he would suggest the start of the Aquarian Age was
  177 years from the date of writing.”. A copy of that letter was given
  to Robbins and then at some point he mentioned it in Journal of
  Esoteric Psychology.”
...
4174 BCE. This is Sheoran's ayanamsha zero date, to which he assigns the
ayanamsha value -60°.
...
sahasrāṇi as "10" instead of "1000" and śatāni as "1" instead of "100".
Unfortunately, Sanskrit dictionaries and grammar do not allow such
translations.

Source:

-  Sunil Sheoran, "The Science of Time and Timeline of World History",
   2017, http://goo.gl/av6vEH .
...
1. is historically the oldest one, but we are not sure about its precise
astronomical definition. It could have been Aldebaran at 15 Taurus and
Antares at 15 Scorpio.
...
of 17.65022". The sidereal ephemeris will then remain identical, but the
tropical ephemeris and the ayanamsha will change. Here, we must
...
a) The soli-lunar precession: The combined gravitational pull of the Sun
      and the Moon on the equatorial bulge of the Earth causes the Earth
      axis to move very slowly, in the way of a spinning top. As a
...
| P\ :sub:`N` = (5029.0966 + 2.22226 \* T-0.000042 \* T\ :sup:`2`) \* t
  + (1.11161 - 0.000127 \* T) \* t\ :sup:`2` - 0.000113 \* t\ :sup:`3`
...
P\ :sub:`N` = 5029.0966 \* t + 1.11161 \* t\ :sup:`2` -
0.000113*t\ :sup:`3`
...
2. Consistent ayanamsha relative to the ecliptic of date (implemented in
Swiss Ephemeris >=2.09 as an option)
...
3. Projection onto the ecliptic of t0 (implemented in Swiss Ephemeris as
an option)
...
the Galactic Centre (Sgr A*) is not really fixed either, but has a small
apparent motion that reflects the motion of the Sun around it.
...
7. The solar system rotation plane (implemented in Swiss Ephemeris as an
option)
...
Horizons System, it is written that: "The Earth is assumed to be a rigid
body. ... These Earth-model approximations result in topocentric station
...
-  **Meteorological circumstances**
   ...
   determined by temperature, air pressure, humidity, visibility range
   (air quality).
...
[1993, 2000] and the implemented by Reijs [2003] and Koch [2009]. The
general ideas behind this theory are explained in the following
subsections.
...
-  Schaefer, B., Astronomy and the limit of vision, Vistas in astronomy,
   36:311, 1993
...
the "Birth place house system". Walter Koch thought that this system was
more related to the birth place than other systems, because all house
cusps are computed with the "polar height of the birth place", which has
the same value as the geographic latitude.
...
(the "Sinusoidal Delta" house system above). Instead, let's proportion
or ratio the entire house sizes themselves to each other based on the
sine wave constants, or multiply instead of add. That results in using a
"sinusoidal ratio" instead of a "sinusoidal delta", so this alternate
method could be called "Sinusoidal Ratio houses". As before, let "x" be
the smallest house in the compressed quadrant. There's a ratio "r"
multiplied by it to get the slightly larger 10th and 12th houses. The
value "r" starts out at 1.0 for 90 degree quadrants, and gradually
increases as quadrant sizes differ. Houses in the large quadrant have
"r" multiplied to "x" 3 times (or 4 times for the largest quadrant).
That results in the (0r, 1r, 3r, 4r) distribution from the sine wave
...
"Sinusoidal Ratio" houses
   ...
   rx x rx r\ :sup:`3`\ x r\ :sup:`4`\ x r\ :sup:`3`\ x

“The unique values for "r" and "x" can be computed based on the quadrant
size "q", given the equations rx + x + rx = q, r\ :sup:`3`\ x +
r\ :sup:`4`\ x + r\ :sup:`3`\ x = 180 - q.”
...
-  There are so-called plus (+) and minus (–) zones. The plus zones are
   the sectors that turned out to be significant in statistical
   investigations, e.g. many top sportsmen turned out to have their Mars
   in a plus zone. The plus sectors are the sectors 36 – 3, 9 – 12, 19 –
   21, 28 – 30.

-  More sophisticated algorithms are used to calculate the exact house
   position of a planet (see chapters 6.4 and 6.5 on house positions and
   Gauquelin sector positions of planets).
...
congress in Poland, the “"XIV Szkola Astrologii Humanistycznej" held by
Dr Leszek Weres, which took place between 15.08.1995 and 28.08.1995 in
Pogorzelica at cost of the Baltic Sea.” Since then Krusinski has
...
point which is called the "East Point" but is usually not located in the
east. In celestial geometry, the expression "East Point" means the point
on the horizon which is in precise eastern direction. The equator goes
through this point as well, at a right ascension which is equal to ARMC
+ 90 degrees. On the other hand, what some astrologers call the "East
Point" is the point on the ecliptic whose right ascension is equal to
ARMC + 90 (i.e. the right ascension of the horizontal East Point). This
point can deviate from eastern direction by 23.45 degrees, the amount of
the ecliptic obliquity. For this reason, the term "East Point" is not
very well-chosen for this ecliptic point, and some astrologers (M.
Munkasey) prefer to call it the *Equatorial Ascendant*, because it is
...
and angle calculation. They are part of Michael Munkasey's system of the
*8 Personal Sensitive Points* (PSP). The PSP include the *Ascendant*,
the *MC*, the *Vertex*, the *Equatorial Ascendant*, the *Aries Point*,
...
take the ARIC as an ARMC and compute the corresponding Ascendant for the
...
The "Polar Ascendant" finally was introduced by Michael Munkasey. It is
the opposition point of Walter Koch's version of the "Co-Ascendant".
However, the "Polar Ascendant" is not the same as an Ascendant computed
for the birth time and one of the geographic poles of the Earth. At the
geographic poles, the Ascendant is always 0 Aries or 0 Libra. This is
not the case for Munkasey's "Polar Ascendant".
...
7. Placidus and Koch house cusps sometimes can, sometimes cannot be
   computed beyond the polar circles. Even the MC doesn't exist always,
   if one defines it in the Placidus manner. Our function therefore
   automatically switches to Porphyry houses (each quadrant is divided
   into three equal parts) and returns a warning.
...
Pullen's code. This will change in due time because we intend to replace
...
(LE431 has ndot = -25.80 arcsec/cty\ :sup:`2`, LE405/406 has ndot =
-25.826 arcsec/cty\ :sup:`2`, ELP2000 and DE200 ndot = -23.8946
arcsec/cty\ :sup:`2`). The ΔT values of Astronomical Almanac are
consistent with ndot = -26 arcsec/cty\ :sup:`2`, those of Stephenson &
alii 2016 with ndot = -25.85 arcsec/cty\ :sup:`2`.
...
+-----------+-----------+-------------------+-------------+----------+
| **Year**  | **ΔT      | **Difference in   | **L         | **L      |
|           | sec**     | ΔT (new-old)**    | (Moon)**    | (Sun)**  |
+===========+===========+===================+=============+==========+
...
Espenak & Meeus use polynomials whereas the former Swiss Ephemeris
...
-  Stephenson, F. R., and L. V. Morrison, "Long-term changes in the
   ...
   Transactions of the Royal Society of London, Series A 313, 47-70
   (1984)
...
-  Stephenson, F.R. & Morrison, L.V., "Long-Term Fluctuations in the
   Earth's Rotation: 700 BCE to CE 1990", in: Philosophical Transactions
   of the Royal Society of London, Ser. A, 351 (1995), 165-202.
...
internal operation, we wrote an interface module which translates all
calls to Placalc functions into Swiss Ephemeris functions, and
translates the results back into the format expected in the Placalc
...
in the field "other options". You can ignore the other fields and leave
them as they are.
...
The parameters "-noaberr -nodefl" tell the program to ignore aberration
of light and gravitational light deflection, but include light-time in
the calculation. These are so-called astrometric positions.
...
scroll up to "Current Settings" and click on [change] in the following
line:

Table Settings [change] : defaults

In the lower table, activate the checkbox "extra precision", scroll down
and click on "use settings above".
...
Get a recent "Astronomical Almanac" from the library or your bookshelf.
If you are too lazy to do that, go on the following page:
...
On p. B70, the result is given as RA = 0h55m33s.8912, DE = 4°23'25".333.
...
E. How to compare the Swiss Ephemeris Lahiri Ayanamsha with *Indian Astronomical Ephemeris* (IAE)
-------------------------------------------------------------------------------------------------
...
“Use of the Newcomb's value for general precession has been discontinued
in this publication with effect from 1985". In what follows, a new
precession formula is given which is taken Lieske’s publication for the
IAU1976 system.

In IAE 2019, p. 445, the following information is given:

| "The algorithms for precession were based on the IAU (1976) value for
  the rate of general precession in ecliptic longitude. Nutation was
  given by the 1980 IAU Theory of Nutation. However, IAU (1976) rate of
  precession had been overestimated by approximately 3 milliarcseconds
  per year. Further observations also revealed periodic errors of a few
  milliarcseconds in the 1980 IAU Theory of Nutation."
| "As part of the 2000 IAU resolutions, the IAU 2000A
  precession-nutation model was introduced, based on an updated value
  for the rate of precession and a completely new nutation theory."
...
|image1|\ swetest -b1.1.2019 -ut0 -pb -sid1 -sidbit8192 -fTL -s3 -n11
(SE 2.09 required!)
...
|image2|\ swetest -b1.1.2020 -ut0 -pb -sid1 -sidbit8192 -fTL -s3 -n11
(SE 2.09 required!)
...
"1989.0". Is it 1 Jan. 0:00 TT or 12:00 TT or is it the Besselian epoch?
...
| TT:  2433282.500000000   ayanamsa =   23°09'31.2539 (Lahiri) (IAE
  1989: 23°09'30.79") diff = 0.46"

| swetest -b1.1.1989 -nonut -fPZ -p -sid1 -sidbit8192 \|grep ayanamsa
| TT:  2447527.500000000   ayanamsa =   23°42'12.3717 (Lahiri) (IAE
  1989: 23°42'12.34") diff = 0.03"

| swetest -b1.1.1990 -nonut -fPZ -p -sid1 -sidbit8192 \|grep ayanamsa
| TT:  2447892.500000000   ayanamsa =   23°43'02.6259 (Lahiri) (IAE
  1989: 23°43'02.62") diff = 0.01"
...
initial value by 0.07" could help to reproduce the mean ayanamshas. With
true ayanamshas, as given in IENA, however, an error of about 0.1 arcsec
will remain, for unknown reasons.
...
1\ :sup:`st` of Caitra = 21 March 1956 (there are no page numbers).
...
ayanamsha 23°18’47” on 1\ :sup:`st` of Caitra = 22 March 1961:
...
*Rashtriya Panchang* of 2019 has the following value for the
1\ :sup:`st` of Caitra or 22 March 2019:
...
.. |image1| image:: media/image34.png
   :width: 2.325in
   :height: 3.33889in
.. |image2| image:: media/image35.png
   :width: 2.19444in
   :height: 3.35625in
